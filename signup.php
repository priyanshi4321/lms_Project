...
if(isset($_POST['signup']))
{
    ...
    // ----------------------------
    $count_my_page = ("studentid.txt"); // File storing last student ID
    $hits = file($count_my_page); // Read the file
    $hits[0] ++; // Increment last ID
    $fp = fopen($count_my_page , "w"); // Open file to write new ID
    fputs($fp , "$hits[0]"); // Write new ID to file
    fclose($fp); // Close file
    $StudentId= $hits[0]; // Assign new Student ID
    
    // ----------------------------
    // Get form input values
    // ----------------------------
    $fname = $_POST['fullanme']; // Full name
